            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        help_text="Required. 12 digits.",
                        max_length=12,
                        unique=True,
                        validators=[
                            django.core.validators.RegexValidator(
                                message="Phone number must be entered in the format: '998901234567. Exactly 12 digits allowed.",
                                regex="^\\d{12}$",
                            )
                        ],
                        verbose_name="phone",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "unit",
                    models.CharField(
                        choices=[("kg", "Kilogram"), ("l", "Litre"), ("pcs", "Pieces")],
                        default="l",
                        max_length=32,
                    ),
                ),
